...
paginate_parser = generate_paginate_parser('file')
document_input_parser = generate_document_input_parser()

document_reversion_parser = reqparse.RequestParser()
document_reversion_parser.add_argument('reversion', location='args', help='The file reversion')

document_input = api.model('File Input', {
    ...
    'reversion': fields.String(required=True, description='The file reversion'),
